...
variable "cluster_security_group_description" {
  ...
  type        = string
  default     = "EKS cluster on ${terraform.workspace} security group"
}
...
variable "node_security_group_description" {
  ...
  type        = string
  default     = "EKS node on ${terraform.workspace} shared security group"
}
...
variable "cluster_iam_role_name" {
  description = "[Required] The eks cluster IAM Role name"
  type        = string
  default = "${local.cluster_name}-cluster-role"
}

variable "node_iam_role_name" {
  description = "[Required] The eks Node IAM Role name"
  type        = string
  default = "${local.cluster_name}-node-role"
}

variable "policy_arn_prefix" {
  description = "Policy ARN prefix"
  type        = string
  default = "arn:${data.aws_partition.current.partition}:iam::aws:policy"
}

variable "cni_policy" {
  description = "Policy for CNI"
  type        = string
  default = "${local.policy_arn_prefix}/AmazonEKS_CNI_Policy"
}
